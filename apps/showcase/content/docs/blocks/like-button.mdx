...
| `ghost` | Borderless minimal style |

### Liked State

<ComponentPreview name="like-button-liked" showV0Button={false} />

### Compact

<ComponentPreview name="like-button-compact" showV0Button={false} />

### Text

<ComponentPreview name="like-button-ghost" showV0Button={false} />
...
| `variant` | `"default" \| "compact" \| "ghost"` | `"default"` | Visual variant |
