...
<ComponentPreview name="friend-button-pending" showV0Button={false} />

### Pending (Received)

When another user has sent a request, Accept and Decline buttons are shown.

<ComponentPreview name="friend-button-received" showV0Button={false} />

### Friends

Once mutual, the button shows "Friends". Hover to reveal the remove option.

<ComponentPreview name="friend-button-friends" showV0Button={false} />
