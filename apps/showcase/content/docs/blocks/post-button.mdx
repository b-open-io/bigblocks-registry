...
```tsx
// Floating action button — ideal for feed pages
<PostButton variant="fab" onPost={handlePost} />

// Compact toolbar button
<PostButton variant="compact" label="New Post" onPost={handlePost} />

// Inline in a card footer
<PostButton variant="inline" label="Write" onPost={handlePost} />
```
