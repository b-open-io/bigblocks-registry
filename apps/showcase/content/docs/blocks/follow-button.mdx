...
```tsx
// Default
<FollowButton bapId={bapId} onFollow={handleFollow} />

// Compact — for tight layouts like post cards
<FollowButton bapId={bapId} variant="compact" onFollow={handleFollow} />

// Pill — for profile pages
<FollowButton bapId={bapId} variant="pill" onFollow={handleFollow} />
```

## Custom Labels

Override the default Follow / Following / Unfollow labels via the `labels` prop.
